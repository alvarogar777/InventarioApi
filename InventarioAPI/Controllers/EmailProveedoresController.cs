...
namespace InventarioAPI.Controllers
{
    ...
    public class EmailProveedoresController : ControllerBase
    {
        ...
        {
            var emailProveedor = await contexto.Emailclientes.ToListAsync();
        ...
        {
            var emailProveedor = await contexto.EmailProveedores.FirstOrDefaultAsync(x => x.CodigoEmail.Equals(id));
        ...
        {
            var emailProveedor = mapper.Map<EmailProveedor>(emailProveedprActualizacion);
